...
class PCAWrapper(object):
    ...
    def add_params(cs: ConfigurationSpace):
        ...
        '''
        pca_switch = CategoricalHyperparameter("pca", choices=[True], default_value=True)
        n_components = UniformIntegerHyperparameter("pca_n_components", lower=1, upper=200, default_value=116, log=True)
